...
export const STRINGS = {
  ...
  /* ---- revenue category analysis (Book1.xlsx, Shrawan) ---- */
  section_category_analysis: { en: "Revenue Category Analysis", np: "राजस्व विश्लेषण" },
  analysis_kicker: { en: "Shrawan · First month of FY 2083/084", np: "श्रावण · आ.व. २०८३/०८४ को पहिलो महिना" },
  section_category_sub: {
    en: "How the 552,725 thousand NPR collected in Shrawan breaks down across the six revenue heads — share, target achievement and year-on-year growth.",
    np: "श्रावण महिनामा संकलित ५,५२,७२५ हजार रुपैयाँ छ राजस्व शीर्षकमा कसरी बाँडिएको छ — हिस्सा, लक्ष्य प्राप्ति र वार्षिक वृद्धि।",
  },
  chart_collection_share: { en: "Monthly Collection by Category", np: "शीर्षक अनुसार मासिक असुली" },
  chart_target_actual: { en: "Target vs Actual Collection", np: "लक्ष्य र वास्तविक असुली" },
  chart_growth_yoy: { en: "Year-over-Year Growth Comparison", np: "गत वर्षको तुलनामा वृद्धि" },
  chart_target_actual_sub: {
    en: "Monthly target against Shrawan collection — green above 100%, orange 80–100%, red below 80%.",
    np: "मासिक लक्ष्य र श्रावण असुली — १००% भन्दा माथि हरियो, ८०–१००% सुन्तला, ८०% मुनि रातो।",
  },
  chart_growth_yoy_sub: {
    en: "Shrawan collection — 2082/083 against 2083/084, with growth flags.",
    np: "श्रावण असुली — २०८२/०८३ र २०८३/०८४ को तुलना, वृद्धि चिन्हसहित।",
  },
  cat_income: { en: "Income Tax", np: "आयकर" },
  cat_rent: { en: "Rent Income Tax", np: "बहाल कर" },
  cat_interest: { en: "Interest Tax", np: "ब्याज कर" },
  cat_vat: { en: "Value Added Tax (VAT)", np: "मू.अ.कर" },
  cat_excise: { en: "Excise Duty", np: "अन्तःशुल्क" },
  cat_other: { en: "Other Taxes", np: "अन्य कर" },
  cat_subtotal_income: { en: "Total Income Tax", np: "जम्मा आयकर" },
  cat_grand_total: { en: "Grand Total", np: "कुल जम्मा" },
  total_collection: { en: "Total collection", np: "कुल असुली" },
  th_revenue_head: { en: "Revenue Head", np: "राजस्व शीर्षक" },
  th_annual_target: { en: "Annual Target", np: "वार्षिक लक्ष्य" },
  th_monthly_target: { en: "Monthly Target", np: "महिनाको लक्ष्य" },
  th_monthly_collection: { en: "Monthly Collection", np: "महिनाको असुली" },
  th_achievement: { en: "Collection %", np: "असुली %" },
  th_contribution: { en: "Contribution %", np: "योगदान %" },
  th_prev_collection: { en: "Prev Year Collection", np: "गत वर्ष असुली" },
  th_growth_pct: { en: "Growth %", np: "वृद्धि %" },
  growth_decrease: { en: "decrease vs last year", np: "गत वर्षभन्दा घटेको" },
  table_category_title: { en: "Category Performance — Shrawan", np: "शीर्षकगत कार्यसम्पादन — श्रावण" },
